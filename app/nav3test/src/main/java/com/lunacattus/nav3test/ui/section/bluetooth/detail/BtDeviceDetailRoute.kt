package com.lunacattus.nav3test.ui.section.bluetooth.detail
...
import com.lunacattus.nav3test.domain.bluetooth.isCommonUuid
import com.lunacattus.nav3test.domain.bluetooth.isVendorUuid
import com.lunacattus.nav3test.ui.ActivityEvent
import com.lunacattus.nav3test.ui.ActivityToastEvent
import com.lunacattus.nav3test.ui.section.bluetooth.BondDevice
import com.lunacattus.nav3test.ui.section.bluetooth.BondDeviceConnectType
import com.lunacattus.nav3test.ui.section.bluetooth.DeviceUUID
...
fun DeviceDetailScreen(
    ...
    LazyColumn(
        ...
        //获取UUID列表
        item {
            UUIDItem(scope, selectedDevice.uuidList, sendUiIntent) {
        ...
        modifier = Modifier
            ...
            .clickableWithDebounce {
                if (deviceUuids.isEmpty()) {
                    scope.launch {
                        ActivityToastEvent.send(ActivityEvent.ShowToast("UUID为空"))
                    }
                } else {
