...
package com.lunacattus.app.player.common.components
...
): Modifier = overScrollOutOfBound(isVertical = true, nestedScrollToParent, scrollEasing, springStiff, springDamp, onOffsetChanged)
...
fun Modifier.overScrollHorizontal(
    ...
    springDamp: Float = OutBoundSpringDamp,
    onOffsetChanged: (Float) -> Unit = {},
): Modifier = overScrollOutOfBound(isVertical = false, nestedScrollToParent, scrollEasing, springStiff, springDamp, onOffsetChanged)
...
fun Modifier.overScrollOutOfBound(
    ...
    LaunchedEffect(offset) {
        onOffsetChanged(offset) // 当 offset 变化时通知外部
    }
